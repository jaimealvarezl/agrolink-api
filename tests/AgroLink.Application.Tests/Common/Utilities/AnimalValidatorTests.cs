...
public class AnimalValidatorTests
{
    ...
    public void ValidateStatusConsistency_ValidCombinations_DoesNotThrow(string sex, ProductionStatus prod, ReproductiveStatus repro)
    {
        // Act & Assert
    ...
    public void ValidateStatusConsistency_MaleOnlyProductionStatusForFemale_ThrowsArgumentException(string sex, ProductionStatus prod, ReproductiveStatus repro)
    {
        // Act & Assert
        var ex = Should.Throw<ArgumentException>(() => AnimalValidator.ValidateStatusConsistency(sex, prod, repro));
    ...
    public void ValidateStatusConsistency_FemaleOnlyProductionStatusForMale_ThrowsArgumentException(string sex, ProductionStatus prod, ReproductiveStatus repro)
    {
        // Act & Assert
        var ex = Should.Throw<ArgumentException>(() => AnimalValidator.ValidateStatusConsistency(sex, prod, repro));
    ...
    {
        // Act & Assert
        var ex = Should.Throw<ArgumentException>(() => AnimalValidator.ValidateStatusConsistency("MALE", ProductionStatus.Bull, ReproductiveStatus.Pregnant));
    ...
    {
        // Act & Assert
        Should.NotThrow(() => AnimalValidator.ValidateStatusConsistency("FEMALE", ProductionStatus.Heifer, ReproductiveStatus.Pregnant));
    }
}
