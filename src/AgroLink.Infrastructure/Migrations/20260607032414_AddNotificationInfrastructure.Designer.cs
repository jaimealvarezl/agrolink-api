...
namespace AgroLink.Infrastructure.Migrations
{
    ...
    [Migration("20260607032414_AddNotificationInfrastructure")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalBcsReading", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AnimalId", "CreatedAt");

                    b.ToTable("AnimalBcsReadings");
                });

            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AnimalBrands");
                });

            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalRetirement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AnimalRetirements");
                });

            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalTag", b =>
                {
                    b.Property<int>("AnimalId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.ChecklistItem", b =>
                {
                    ...
                    b.HasIndex("ChecklistId", "AnimalId")
                        .IsUnique();
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.DailyMilkLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DailyMilkLogs");
                });

            modelBuilder.Entity("AgroLink.Domain.Entities.DeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.OwnerBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.ReproductiveEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AnimalId", "EventType", "Date");

                    b.ToTable("ReproductiveEvents");
                });

            modelBuilder.Entity("AgroLink.Domain.Entities.SentNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AnimalId", "NotificationType", "ExpectedDueDate")
                        .IsUnique();

                    b.ToTable("SentNotifications", (string)null);
                });

            modelBuilder.Entity("AgroLink.Domain.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("FarmId", "CanonicalName")
                        .IsUnique();
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalBcsReading", b =>
                {
                    b.HasOne("AgroLink.Domain.Entities.Animal", "Animal")
                        .WithMany("BcsReadings")
                        .HasForeignKey("AnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgroLink.Domain.Entities.User", "ConfirmedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalBrand", b =>
                {
                    ...
                    b.HasOne("AgroLink.Domain.Entities.OwnerBrand", "OwnerBrand")
                        .WithMany("AnimalBrands")
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalRetirement", b =>
                {
                    b.HasOne("AgroLink.Domain.Entities.Animal", "Animal")
                        .WithOne("Retirement")
                        .HasForeignKey("AgroLink.Domain.Entities.AnimalRetirement", "AnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.AnimalTag", b =>
                {
                    ...
                    b.HasOne("AgroLink.Domain.Entities.Tag", "Tag")
                        .WithMany("AnimalTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.Movement", b =>
                {
                    ...
                    b.HasOne("AgroLink.Domain.Entities.Lot", "FromLot")
                        .WithMany()
                        .HasForeignKey("FromLotId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AgroLink.Domain.Entities.Lot", "ToLot")
                        .WithMany()
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.ReproductiveEvent", b =>
                {
                    b.HasOne("AgroLink.Domain.Entities.Animal", "Animal")
                        .WithMany("ReproductiveEvents")
                        .HasForeignKey("AnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgroLink.Domain.Entities.Animal", "Bull")
                        .WithMany()
                        .HasForeignKey("BullId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AgroLink.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.Animal", b =>
                {
                    ...
                    b.Navigation("ReproductiveEvents");
            ...
            modelBuilder.Entity("AgroLink.Domain.Entities.Owner", b =>
                {
                    ...
                    b.Navigation("OwnerBrands");
                });

            modelBuilder.Entity("AgroLink.Domain.Entities.OwnerBrand", b =>
                {
                    b.Navigation("AnimalBrands");
                });
